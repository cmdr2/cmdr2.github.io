...
Freebird's v2 has given me sufficient confidence that a DOM-style API for building 3D experiences (in an actual [shipping, selling product](https://freebirdxr.com/buy)) is productive and scalable. It's already way more productive and scalable than the spaghetti code of Freebird v1.
