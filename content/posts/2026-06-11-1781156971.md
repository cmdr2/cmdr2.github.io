...
I'm obviously going to continue using my custom editor (it solves an important problem for me), but this event is a useful reminder to make sure that the critical aspects of a system are provable (via tests) when using AI to build stuff. For e.g. data reliability in this case, probably something else in another project.